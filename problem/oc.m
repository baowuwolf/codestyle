...
NSURLSessionDownloadTask *dataTask = [self.httpSessionManager downloadTaskWithRequest:request progress:^(NSProgress * _Nonnull downloadProgress) {
...
@weakify(self)
// 本地
[[LocalParseExtStreamHelper sharedInstance] getPlayAddressWithUrl: self.currentExtOriginUrl
apiUrls: apiList
header: header
uStreams: steamList
rule: rule
